...
Test At dbl-GAT201 mutant P2.7ZH_B7-B12 and C1-C4 from Plate 1_P2.7ZH(glycerol stock, called dblGAT201a) and At dbl-GAT201 mutant P2.28EH_B7-B12 and C1-C4 from Plate 1_P2.28EH(glycerol stock, called dblGAT201b) in RPMI at 37 degrees.
...
platemap <- read.csv("../Input/20230407_RPMI_Atmut_screen_Plate4_setup.csv") %>%     
  dplyr::mutate(
    Strain = factor(Strain, 
                    levels = c( "P2.7B7", "P2.7B8","P2.7B9","P2.7B10","P2.7B11","P2.7B12","P2.7C1","P2.7C2","P2.7C3","P2.7C4", "P2.28B7","P2.28B8","P2.28B9","P2.28B10","P2.28B11","P2.28B12","P2.28C1","P2.28C2","P2.28C3","P2.28C4"),
                    labels = c("dblGAT201a-B7", "dblGAT201a-B8","dblGAT201a-B9","dblGAT201a-B10","dblGAT201a-B11","dblGAT201a-B12","dblGAT201a-C1","dblGAT201a-C2","dblGAT201a-C3", "dblGAT201b-C4", "dblGAT201b-B7","dblGAT201b-B8","dblGAT201b-B9","dblGAT201b-B10","dblGAT201b-B11","dblGAT201b-B12","dblGAT201b-C1","dblGAT201b-C2","dblGAT201b-C3","dblGAT201b-C4"))
  )
head(platemap, n=10)
...
Remove well A6, A12, H3, F1 if using all blanks to noemalize.
